...
public class PsiTwentyFourHourly implements Parcelable {
     ...
     * @param west
     */
    public PsiTwentyFourHourly(Integer national, Integer south, Integer north, Integer east, Integer central, Integer west) {
    ...
    public static final Parcelable.Creator<PsiTwentyFourHourly> CREATOR = new Parcelable.Creator<PsiTwentyFourHourly>() {
        @Override
        public PsiTwentyFourHourly createFromParcel(Parcel source) {
            return new PsiTwentyFourHourly(source);
        }

        @Override
        public PsiTwentyFourHourly[] newArray(int size) {
            return new PsiTwentyFourHourly[size];
        }
    };
}
