...
public class So2SubIndex implements Parcelable {
     ...
     * @param west
     */
    public So2SubIndex(Integer national, Integer south, Integer north, Integer east, Integer central, Integer west) {
    ...
    public static final Parcelable.Creator<So2SubIndex> CREATOR = new Parcelable.Creator<So2SubIndex>() {
        @Override
        public So2SubIndex createFromParcel(Parcel source) {
            return new So2SubIndex(source);
        }

        @Override
        public So2SubIndex[] newArray(int size) {
            return new So2SubIndex[size];
        }
    };
}
