...
public class Pm25SubIndex implements Parcelable {
     ...
     * @param west
     */
    public Pm25SubIndex(Integer national, Integer south, Integer north, Integer east, Integer central, Integer west) {
    ...
    public static final Parcelable.Creator<Pm25SubIndex> CREATOR = new Parcelable.Creator<Pm25SubIndex>() {
        @Override
        public Pm25SubIndex createFromParcel(Parcel source) {
            return new Pm25SubIndex(source);
        }

        @Override
        public Pm25SubIndex[] newArray(int size) {
            return new Pm25SubIndex[size];
        }
    };
}
