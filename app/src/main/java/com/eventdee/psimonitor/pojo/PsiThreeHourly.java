...
public class PsiThreeHourly implements Parcelable {
     ...
     * @param west
     */
    public PsiThreeHourly(Integer national, Integer south, Integer north, Integer east, Integer central, Integer west) {
    ...
    protected PsiThreeHourly(Parcel in) {
    ...
    public static final Parcelable.Creator<PsiThreeHourly> CREATOR = new Parcelable.Creator<PsiThreeHourly>() {
        @Override
        public PsiThreeHourly createFromParcel(Parcel source) {
            return new PsiThreeHourly(source);
        }

        @Override
        public PsiThreeHourly[] newArray(int size) {
            return new PsiThreeHourly[size];
        }
    };
}
