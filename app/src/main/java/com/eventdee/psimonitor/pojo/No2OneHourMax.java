...
public class No2OneHourMax implements Parcelable {
     ...
     * @param west
     */
    public No2OneHourMax(Integer national, Integer south, Integer north, Integer east, Integer central, Integer west) {
    ...
    public static final Parcelable.Creator<No2OneHourMax> CREATOR = new Parcelable.Creator<No2OneHourMax>() {
        @Override
        public No2OneHourMax createFromParcel(Parcel source) {
            return new No2OneHourMax(source);
        }

        @Override
        public No2OneHourMax[] newArray(int size) {
            return new No2OneHourMax[size];
        }
    };
}
