...
public class Pm25TwentyFourHourly implements Parcelable {
     ...
     * @param west
     */
    public Pm25TwentyFourHourly(Integer national, Integer south, Integer north, Integer east, Integer central, Integer west) {
    ...
    public static final Parcelable.Creator<Pm25TwentyFourHourly> CREATOR = new Parcelable.Creator<Pm25TwentyFourHourly>() {
        @Override
        public Pm25TwentyFourHourly createFromParcel(Parcel source) {
            return new Pm25TwentyFourHourly(source);
        }

        @Override
        public Pm25TwentyFourHourly[] newArray(int size) {
            return new Pm25TwentyFourHourly[size];
        }
    };
}
