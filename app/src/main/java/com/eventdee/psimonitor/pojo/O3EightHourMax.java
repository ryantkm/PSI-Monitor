...
public class O3EightHourMax implements Parcelable {
     ...
     * @param west
     */
    public O3EightHourMax(Integer national, Integer south, Integer north, Integer east, Integer central, Integer west) {
    ...
    public static final Parcelable.Creator<O3EightHourMax> CREATOR = new Parcelable.Creator<O3EightHourMax>() {
        @Override
        public O3EightHourMax createFromParcel(Parcel source) {
            return new O3EightHourMax(source);
        }

        @Override
        public O3EightHourMax[] newArray(int size) {
            return new O3EightHourMax[size];
        }
    };
}
